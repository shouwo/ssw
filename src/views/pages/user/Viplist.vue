...
export default {
  ...
  methods: {
    ...
    upRecordss1(val) {
      ...
      this.upRecord.founder=val.createPerson,
    ...
    save() {
      ...
      console.log(this.form.tels.length);

      // console.log(this.form.wish_rate instanceof Number)
      if (this.form.higher_agent == "") {
        alert("请输入上级代理");
      } else if (this.form.id == "") {
        alert("请输入账号");
      } else if (this.form.namess == "") {
        alert("请输入姓名");
      } else if (this.form.card == "") {
        alert("请输入洗码卡号");
      } else if (this.form.tels == "") {
        alert("请输入电话");
      } else if (this.form.ps == "") {
        alert("请输入备注");
      } else if (this.form.wish_rate == "") {
        alert("请输入洗码率");
      } else if (this.form.createPerson == "") {
        alert("请输入创建人");
      } else {
        if (this.form.tels.length < 11 && this.form.tels.length > 5) {
          if (
            0 < parseFloat(this.form.wish_rate) &&
            1 > parseFloat(this.form.wish_rate)
          ) {
            addVip(
              this.form.id,
              this.form.card,
