      ...
      <div id="bigbox">
        <el-form id="main" ref="form" :model="form" label-width="80px">
          <el-form-item label="账号：">
            <el-input placeholder="请输入账号" v-model="form.accnum" size="mini" style="width:120px;" id="accnum"></el-input>
          </el-form-item>
          <el-form-item label="姓名：">
            <el-input placeholder="请输入姓名" v-model="form.name" size="mini" style="width:120px;"></el-input>
          </el-form-item>
          <el-form-item label="电话：">
            <el-input placeholder="请输入电话" v-model="form.tel" size="mini" maxlength='11' style="width:120px;" @blur="tel"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button
      ...
      <div class="tabellist">
        ...
        <el-table class="tabeld" style="width:100%;" :data="tableData" border>
          ...
          <el-table-column fixed="right" label="操作" width="150" prop="uptime">
           ...
           <!-- 修改弹出框 -->
            	<el-dialog title="修改记录" :visible.sync="upRecordss" style="text-align: center;margin-top: -100px;">
           	  <el-form :model="upRecord" class="thisForm1" style="margin-top: -20px;">
           	    <el-form-item label-width="100px" label="用户类型">
           	      <el-input v-model="upRecord.type"  size="mini" style="width: 150px;" placeholder="请输入用户类型"></el-input>
           	    </el-form-item>
           	    <el-form-item label-width="100px" label="上级代理">
           	      <el-input v-model="upRecord.upagent"  size="mini" style="width: 150px;" placeholder="请输入上级代理"></el-input>
           	    </el-form-item>
           	    <el-form-item label-width="100px" label="账号">
           	      <el-input v-model="upRecord.accountnum"  size="mini" style="width: 150px;" placeholder="请输入账号"></el-input>
           	    </el-form-item>
           	    ...
           	    <el-form-item label-width="100px" label="卡号">
           	      <el-input v-model="upRecord.cardnum"  size="mini" style="width: 150px;" placeholder="请输入卡号"></el-input>
           	    </el-form-item>
           	    ...
           	    <el-form-item label-width="100px" label="备注">
           	      <el-input v-model="upRecord.remarks"  size="mini" style="width: 150px;" placeholder="请输入备注"></el-input>
           	    </el-form-item>
           								
           	    <el-form-item label-width="100px" label="占成">
           	      <el-input v-model="upRecord.share"  size="mini" style="width: 150px;" placeholder="请输入占成"></el-input>
           	    </el-form-item> 
           								
           								<el-form-item label-width="100px" label="洗码率">
           								  <el-input v-model="upRecord.wash"  size="mini" style="width: 150px;" placeholder="请输入洗码率"></el-input>
           								</el-form-item>
           								<el-form-item label-width="100px" label="上次平单时间">
           								  <el-input v-model="upRecord.uptime"  size="mini" style="width: 150px;" placeholder="请输入上次平单时间"></el-input>
           								</el-form-item>
           								<el-form-item label-width="100px" label="返点收益">
           								  <el-input v-model="upRecord.profit"  size="mini" style="width: 150px;" placeholder="请输入返点收益"></el-input>
           								</el-form-item>
           								<el-form-item label-width="100px" label="分摊费用">
           								  <el-input v-model="upRecord.cost"  size="mini" style="width: 150px;" placeholder="请输入分摊费用"></el-input>
           								</el-form-item>
           								<el-form-item label-width="100px" label="创建时间">
           								  <el-input v-model="upRecord.time"  size="mini" style="width: 150px;" placeholder="请输入创建时间"></el-input>
           								</el-form-item>
           								<el-form-item label-width="100px" label="创建人">
           								  <el-input v-model="upRecord.founder"  size="mini" style="width: 150px;" placeholder="请输入创建人"></el-input>
           								</el-form-item>
           								
           	  </el-form>
           		<div >
           	    <el-button type="primary" size="mini" style="margin-top: 10px;width: 120px;" @click="upSure" :plain="true">确定</el-button>
           			 <el-button type="primary" size="mini" style="margin-top: 10px;width: 120px;" @click="upCancel" :plain="true">取消</el-button>
           		</div>  	
           </el-dialog>
      <!-- 分页 -->
      <div class="fen">
...
import { types } from "../../../apis/apis.js";
export default {
  data() {
    return {
			choices:[],
  ...
  methods: {
    ...
    onSubmita1() {
      ...
      // var accnum=this.form.accnum;
			...
			// var tel=this.form.tel;
			// if(accnum==null||accnum==""||names==""||names==null||tel==null||tel==""){
			// 	alert("查询输入框不能为空！！！");
