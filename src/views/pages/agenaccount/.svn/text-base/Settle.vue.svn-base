      ...
      <div class="inputcolors" style="padding:8px 0 0 20px;text-align: left;font-size: 14px;">
        <div id="bigbox">
          <el-form id="box" style="margin-bottom:10px;" ref="form" :model="form" label-width="80px">
            ...
            <el-radio-group class="time" v-model="singe.resource">
...
export default {
  ...
  methods: {
    ...
    onSubmit3() {
      detailssettlelist().then(res => {
        console.log(res);
      });
      this.$router.push("/index/settledetails");
    },
