  ...
  <div id="app">
    ...
    <div class="bigbread">
      <div class="bread">
        ...
        <span>
          <router-link to="/index/accountlist" style="text-decoration:none;color:#fff;">代理账目结账</router-link>
        </span>/
        <span>详情</span>
      </div>
    </div>
	...
	switch (money){
	    ...
	    settleaccountlist(
	      ...
	      console.log(res);
				...
				this.moneyTypes1=res.data.data.moneyType;
				switch (this.moneyTypes1){
					case 1:
					this.tableData[0].moneyType="RMB";
						break;
						case 0:
						this.tableData[0].moneyType="USD";
							break;
					default:
						this.tableData[0].moneyType="RMB";
						break;
